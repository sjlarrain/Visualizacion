...
const avocadoCount = (data, type) => {
    ...
    const maxValue = NaN; // Rellenar

    // (tip: recordar que a los arrays de JS se les puede aplicar .sort )

    data =  NaN;// Aquí debes rellenar con una forma de ordenar los datos de más antiguos a mas nuevos. 👀
    ...
    const xAxis = d3.axisBottom();// completar
    const yAxis = d3.axisLeft(); // completar
    ...
    svg.selectAll(".title") // completar
    
    svg.selectAll("#xLabel") // completar
